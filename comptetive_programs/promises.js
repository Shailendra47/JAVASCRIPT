...
for the ease of understanding, we are using an operation to calculate the sum of three elements.
*/
...
/*
In the code above, we are calculating the sum of three elements, if the length of elements array is more than 3, promise is rejected, 
